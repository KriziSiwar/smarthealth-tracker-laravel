...
class ActivityController extends Controller
{
    ...
    // ✅ Nouvelle méthode de statistiques
   public function stats()
{
    $activitiesByType = \DB::table('activities')
        ->select('activity_type_id', \DB::raw('count(*) as total'))
        ->groupBy('activity_type_id')
        ->get();

    $caloriesByType = \DB::table('activities')
        ->select('activity_type_id', \DB::raw('SUM(calories_burned) as total_calories'))
        ->groupBy('activity_type_id')
        ->get();

    $types = ActivityType::pluck('name', 'id');

    return view('activities.stats', compact('activitiesByType', 'caloriesByType', 'types'));
}
