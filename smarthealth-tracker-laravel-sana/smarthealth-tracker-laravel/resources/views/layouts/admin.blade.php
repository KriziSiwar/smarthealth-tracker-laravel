...
<head>
    ...
    <title>Dashboard Admin - SmartHealth</title>

    <!-- CSS du template SB Admin -->
...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand ps-3" href="{{ route('admin.dashboard') }}">SmartHealth Admin</a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button"
                   data-bs-toggle="dropdown" aria-expanded="false">
                    <i class="fas fa-user fa-fw"></i> {{ Auth::user()->name ?? 'Admin' }}
                </a>
                        ...
                        <div class="collapse" id="collapseChallenges" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="{{ route('admin.user-challenges.index') }}">Participations</a>
                                 <a class="nav-link" href="{{ route('admin.user-challenges.stats') }}">Statistiques</a>

                            </nav>
                        </div>

                        <!-- Activités -->
                        <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseActivities"
                           aria-expanded="false" aria-controls="collapseActivities">
                            <div class="sb-nav-link-icon"><i class="fas fa-running"></i></div>
                            Activités
                            <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                        </a>
                        <div class="collapse" id="collapseActivities" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="{{ route('admin.activities.index') }}">Toutes les activités</a>
                                <a class="nav-link" href="{{ route('admin.activity-types.index') }}">Types d'activités</a>
                            </nav>
                        </div>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">&copy; 2025 SmartHealth</div>
                        <div>
